<template>
  <div>
    ...
    <div class="text-center">
      ...
      <p>
        oder
        <a class="text-vue2" role="button" @click="changeComponent('TheMyLogin')"
...
export default {
  ...
  emits: {
    "change-component": (payload) => {
      if (payload.componentName !== "TheMyLogin") {
        return false;
      }
      return true;
    },
  ...
  data() {
    const schema = yup.object().shape({
      ...
      password: yup
        ...
        .min(8, "Das Passwort muss mindestens acht Zeichen lang sein"),
      confirmPassword: yup
        .string()
    ...
    submitData(values) {
      ...
      this.$store
        ...
        .then(() => {
          ...
          this.changeComponent("TheMyLogin");
        })
        .catch((error) => {
